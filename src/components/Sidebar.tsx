...
const mainItems: SidebarItem[] = [
  ...
  { label: "Ciclo del Agua 3D", route: "/three", icon: <FaCube /> },
  ...
  { label: "Simulación de Robots", route: "/robots", icon: <FaRobot /> },
  { label: "Mapa 3D Interactivo", route: "/mapa3d", icon: <FaGlobeAmericas /> },
];
